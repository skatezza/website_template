      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="h2 font-rose-hat-display mb-4 text-gray-100">
          ...
          <div className="max-w-xs mx-auto grid gap-6 sm:grid-cols-2 lg:grid-cols-4 items-start sm:max-w-none md:max-w-2xl lg:max-w-none">
            {/* Pricing table 1 */}
            <div
              className="flex flex-col h-full p-6 bg-white dark:bg-gray-800 shadow border-2 border-transparent dark:border-rose-500"
              data-aos="fade-down"
            >
              <div className="grow mb-4 pb-4">
                <div className="flex justify-between items-center mb-1">
                  <div className="text-xl font-bold font-rose-hat-display">
                    Yearly
                  </div>
                  <div className="inline-flex px-3 py-1 text-xs font-medium text-rose-600 dark:text-rose-400 bg-rose-200 dark:bg-rose-600 dark:bg-opacity-25 rounded-full">
                    -40%
                  </div>
                </div>
                <div className="font-rose-hat-display inline-flex items-baseline mb-2">
              ...
              <div className="mt-24">
                <a
                  className="btn-sm text-white bg-rose-500 hover:bg-rose-400 w-full"
                  href="#0"
                >
                  Go Premium
                </a>
            ...
            >
              ...
              <div className="mt-24">
                <a
                  className="btn-sm text-white bg-purple-500 hover:bg-purple-400 dark:text-rose-400 dark:bg-gray-700 dark:hover:bg-gray-600 w-full"
                  href="#0"
                >
                  Go Premium
                </a>
            ...
            <div className="sm:order-first">
              ...
              <div className="text-lg font-bold font-rose-hat-display mb-4 mt-4 sm:mt-0 text-gray-100">
                All plans include:
              </div>
              <ul className="text-gray-400 -mb-2 grow">
                <li className="flex items-center mb-2">
                  <svg
                    className="w-3 h-3 fill-current text-rose-500 mr-3 shrink-0"
                    viewBox="0 0 12 12"
                    xmlns="http://www.w3.org/2000/svg"
                  >
