export default function HeroHelp() {
  return (
    <section className="relative">
      {/* Background gradient (light version only) */}
      <div
        className="absolute inset-0 bg-gradient-to-t from-gray-100 to-white pointer-events-none dark:hidden"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="h1 font-rose-hat-display mb-4" data-aos="fade-down">
            ...
            <p
              ...
              data-aos-delay="150"
            >
              Bite sized guides and tutorials to help you get the most out of
              Appy.
            </p>
            <div className="max-w-2xl mx-auto md:px-4">
              ...
              >
                ...
                >
                  <svg
                    className="w-4 h-4 shrink-0 ml-4 mr-3"
                    viewBox="0 0 16 16"
