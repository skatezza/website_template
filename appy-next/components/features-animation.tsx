      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 font-rose-hat-display mb-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative flex justify-center items-center overflow-hidden">
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-rose-500 bg-gradient-to-tr from-rose-500 to-rose-400 dark:bg-rose-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-1 mt-72">
                  Components
                </div>
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-rose-500 bg-gradient-to-tr from-rose-500 to-rose-400 dark:bg-rose-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-5 mt-14">
                  Tools & Widgets
                </div>
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-rose-500 bg-gradient-to-tr from-rose-500 to-rose-400 dark:bg-rose-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-9 mt-80 top-4">
                  Perks
                </div>
                <div className="absolute font-medium px-4 py-2 text-white dark:text-rose-500 bg-gradient-to-tr from-rose-500 to-rose-400 dark:bg-rose-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-10 mt-56">
                  Product & Design
                </div>
              </div>
