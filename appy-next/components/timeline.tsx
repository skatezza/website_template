            ...
            <div className="flex items-start">
              ...
              <div className="relative mr-4 sm:mr-12 lg:mr-32">
                ...
                >
                  ...
                  <span
                    className={`block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full ${
                      year === "2020" && "bg-rose-500 dark:bg-rose-500"
                    }`}
                  ></span>
                </button>
                <button
                ...
                >
                  ...
                  <span
                    className={`block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full ${
                      year === "2019" && "bg-rose-500 dark:bg-rose-500"
                    }`}
                  ></span>
                </button>
                <button
                ...
                >
                  ...
                  <span
                    className={`block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full ${
                      year === "2018" && "bg-rose-500 dark:bg-rose-500"
                    }`}
                  ></span>
                </button>
                <button
                ...
                >
                  ...
                  <span
                    className={`block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full ${
                      year === "2017" && "bg-rose-500 dark:bg-rose-500"
                    }`}
                  ></span>
                </button>
                <button
                ...
                >
                  ...
                  <span
                    className={`block w-3.5 h-3.5 bg-gray-400 dark:bg-gray-700 border-2 border-white dark:border-gray-900 rounded-full ${
                      year === "2016" && "bg-rose-500 dark:bg-rose-500"
                    }`}
                  ></span>
                </button>
              </div>
              ...
              <div className={`grow ${year !== "2020" && "hidden"}`}>
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                  <article className="p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
                    <header>
                      <h3 className="h4 font-rose-hat-display mb-1">
