...
export default function TestimonialsCircles() {
  ...
  const [items] = useState([
    ...
    },
    {
      ...
      comment:
        "When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams sred into the inner sanctuary, I throw myself down among the tall grass by the trickling stream.",
      name: "Leonel Roy",
    },
    {
      image: UserImage4,
