          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative" data-aos="fade-down">
              ...
              <div className="absolute inset-0 flex items-center justify-between">
                <button
                  className="relative z-20 w-12 h-12 p-1 box-content flex items-center justify-center group transform -translate-x-2 md:-translate-x-1/2 bg-rose-500 hover:bg-rose-400 dark:bg-gray-800 dark:hover:bg-rose-500 dark:hover:bg-opacity-25 transition duration-150 ease-in-out"
                  onClick={() => {
