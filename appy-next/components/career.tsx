...
import CareerImage01 from "@/public/images/career-01.jpg";
import CareerImage02 from "@/public/images/career-02.jpg";
import CareerImage03 from "@/public/images/career-03.jpg";
import CareerImage04 from "@/public/images/career-04.jpg";
import CareerImage05 from "@/public/images/career-05.jpg";
import CareerImage06 from "@/public/images/career-06.jpg";
...
export default function Career() {
  return (
    <section className="relative border-t border-gray-200 dark:border-gray-800">
      {/* Background gradient */}
      <div
        className="absolute inset-0 opacity-25 bg-gradient-to-b from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 pointer-events-none"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-rose-hat-display mb-4">
          ...
          <div className="lg:flex lg:items-start lg:justify-between">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 m-4 text-center text-white">
                      <h4 className="text-lg font-rose-hat-display font-bold tracking-tight break-words">
                        Development
                      </h4>
            ...
            <div className="max-w-lg mx-auto lg:w-64 mt-8 lg:mt-0 lg:ml-0 lg:mr-6">
              <h3 className="text-lg font-bold tracking-tight text-center lg:text-left mb-4">
                Locations
              </h3>
              <ul className="flex flex-wrap justify-center lg:flex-col lg:justify-start font-medium -mx-3 -my-1 lg:mx-0">
                <li className="px-3 py-1 lg:px-0">
                  <a className="flex items-center text-rose-500" href="#0">
                    <svg
                      className="w-4 h-4 shrink-0 fill-current text-gray-400 dark:text-gray-500 mr-3"
                      viewBox="0 0 16 16"
                ...
                <li className="px-3 py-1 lg:px-0">
                  <a
                    className="flex items-center text-gray-600 dark:text-gray-400 hover:text-rose-500"
                    href="#0"
                  >
                    <svg
                      className="w-4 h-4 shrink-0 fill-current text-gray-400 dark:text-gray-500 mr-3"
