      ...
      <div className="py-12 md:py-20">
            ...
            <div className="swiper-slide max-w-lg">
              ...
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="flex grow">
                  <a
                    className="inline-flex btn-sm text-white bg-rose-500 hover:bg-rose-400 mx-auto self-center"
                    href="#0"
                  >
                    Learn more
                  </a>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mt-12 md:mt-16">
            <button className="carousel-prev relative z-20 w-12 h-12 p-1 box-content flex items-center justify-center group bg-rose-500 hover:bg-rose-400 dark:bg-gray-800 dark:hover:bg-rose-500 dark:hover:bg-opacity-25 shadow-xl transition duration-150 ease-in-out">
              <span className="sr-only">Previous</span>
              <svg
                className="w-4 h-4 fill-current text-white dark:text-gray-400 group-hover:text-white dark:group-hover:text-rose-500 transition duration-150 ease-in-out"
                viewBox="0 0 16 16"
            ...
            <button className="carousel-next relative z-20 w-12 h-12 p-1 box-content flex items-center justify-center group bg-rose-500 hover:bg-rose-400 dark:bg-gray-800 dark:hover:bg-rose-500 dark:hover:bg-opacity-25 shadow-xl transition duration-150 ease-in-out">
