          ...
          <div className="py-6 pr-4 pl-20">
            ...
            <ul>
              ...
              <li>
                <Link
                  href="/contact"
                  className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded text-white bg-rose-500 hover:bg-rose-400 transition duration-150 ease-in-out"
                  onClick={() => setMobileNavOpen(false)}
                >
                  Request code
                </Link>
