                    ...
                    <path
                      className={`fill-current ${
                        category === "1"
                          ...
                          : "text-rose-500 dark:text-gray-400"
                      }`}
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900 bg-opacity-50 dark:text-rose-400 dark:bg-rose-600 dark:bg-opacity-25 rounded-full">
                            2 Min
                          </div>
                        </div>
                      </div>
