      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-rose-hat-display">
          ...
          >
            {/* 1st item */}
            <a
              className="flex flex-col items-center text-center p-5 text-white group bg-gradient-to-tr from-rose-500 to-rose-400 dark:to-rose-500 shadow-2xl"
              href="#0"
              data-aos="fade-down"
            ...
            >
              ...
              >
                <path
                  ...
                  d="M11.586 23l-3-3L10 18.586 15.414 24 10 29.414 8.586 28l3-3H3v-8h2v6h6.586zm8.828-14l3 3L22 13.414 16.586 8 22 2.586 23.414 4l-3 3H29v8h-2V9h-6.586zM7 14A7 7 0 117 0a7 7 0 010 14zm0-2A5 5 0 107 2a5 5 0 000 10zm18 20a7 7 0 110-14 7 7 0 010 14zm0-2a5 5 0 100-10 5 5 0 000 10z"
                  fill="#FFF"
                  fillRule="nonzero"
                />
              </svg>
              ...
              <div className="grow opacity-80 mb-3">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </div>
              <svg
                className="w-4 h-4 mb-1 transform group-hover:rotate-45 transition duration-150 ease-in-out"
                viewBox="0 0 16 16"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  className="fill-current"
                  d="M14 1H6v2h5.586L1.293 13.293l1.414 1.414L13 4.414V10h2V2a1 1 0 00-1-1z"
                />
              </svg>
            </a>
