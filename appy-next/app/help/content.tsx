        ...
        <div className="py-12 md:py-20">
          <div data-aos="fade-up" data-aos-delay="450">
            ...
            <div className="mb-10">
              <div className="flex flex-wrap justify-center -m-1">
                ...
                <button
                  className={`font-medium px-4 py-2 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 shadow transition duration-150 ease-in-out rounded-full inline-flex items-center justify-center m-1 ${
                    category === "1" &&
                    "bg-rose-500 hover:bg-rose-500 dark:bg-rose-600 dark:hover:bg-rose-600 dark:bg-opacity-25 dark:hover:bg-opacity-25"
                  }`}
                ...
                >
                  ...
                  >
                    <path
                      className={`fill-current ${
                        category === "3"
                          ? "text-indigo-200 dark:text-indigo-400"
                          : "text-indigo-500"
                      }`}
                ...
                >
                  ...
                  >
                    <path
                      className={`fill-current ${
                        category === "4"
                          ? "text-pink-200 dark:text-pink-400"
                          : "text-pink-500"
                      }`}
            ...
            <div className="-mb-2">
              {/* 1st Article */}
              <article
                className={`mb-2 ${!["", "1"].includes(category) && "hidden"}`}
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="fill-current text-rose-100 dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-rose-hat-display text-xl font-black tracking-tighter mb-1">
                    ...
                    <a
                      className="inline-flex items-center font-medium text-rose-500 hover:underline mt-2"
                      href="#0"
                    >
              ...
              {/* 2nd Article */}
              <article
                className={`mb-2 ${!["", "2"].includes(category) && "hidden"}`}
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  {/* Category icon */}
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="fill-current text-purple-100 dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
              ...
              {/* 3rd Article */}
              <article
                className={`mb-2 ${!["", "3"].includes(category) && "hidden"}`}
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  {/* Category icon */}
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="fill-current text-indigo-100 dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
              ...
              {/* 4th Article */}
              <article
                className={`mb-2 ${!["", "4"].includes(category) && "hidden"}`}
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  {/* Category icon */}
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="fill-current text-pink-100 dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
            ...
            <nav className="flex justify-center sm:justify-between mt-12">
              <span className="hidden sm:inline-flex items-center font-medium text-gray-400 dark:text-gray-500">
                <svg
                  className="w-3 h-3 shrink-0 mt-px mr-2"
                  viewBox="0 0 12 12"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
              ...
              <ul className="flex">
                <li className="mx-1">
                  <a
                    className="inline-flex text-rose-500 px-1 border-b border-rose-500 transition duration-150 ease-in-out"
                    href="#0"
                  >
                    1
                  </a>
              ...
              <a
                className="hidden sm:inline-flex items-center font-medium text-rose-500 hover:underline"
                href="#0"
              >
                <span>Next</span>
                <svg
