export default function Sidebar() {
  return (
    ...
    >
      {/* Popular posts */}
      <div className="mb-8">
        <h4 className="h4 font-rose-hat-display mb-5">Popular on Simple</h4>
        <ul className="-my-3">
          <li className="flex py-3 border-b border-gray-200 dark:border-gray-800">
            <div className="h4 w-12 font-rose-hat-display text-gray-400 dark:text-gray-600 shrink-0 mt-1">
              01
            </div>
            <article>
              <a className="hover:underline" href="/#0">
                <h3 className="font-rose-hat-display font-bold tracking-tight mb-1">
